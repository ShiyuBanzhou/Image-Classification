...
class VGG19CIFAR10(nn.Module):
    ...
    def __init__(self, num_classes=10, dropout_prob=0.5, pretrained=False): # 添加 pretrained 选项
        ...
        # CIFAR-10 图像是 32x32。经过 VGG19 特征层（5个最大池化）后，尺寸变为 1x1
        # VGG19 特征层输出 512 个通道。
...
if __name__ == '__main__':
    ...
    print("正在运行 VGG19.py 进行训练...") # User-facing message in Chinese
    set_seed(42)
    ...
    model = VGG19CIFAR10(num_classes=10, pretrained=USE_PRETRAINED).to(device)
