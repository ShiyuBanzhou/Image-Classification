...
# --- 模型定义 (PreActResNet Bottleneck Block 和 Model) ---
class PreActBottleneck(nn.Module):
    '''原始 Bottleneck 模块的预激活版本。'''
    expansion = 4
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        if stride != 1 or in_planes != self.expansion*planes:
            self.shortcut = nn.Sequential(
                ...
                # 注意：原始 PreActResNet 论文在此处的 bottleneck shortcut 中使用 BN
...
def PreActResNet50(num_classes=100): # <--- 修改默认值
    """构建一个用于 CIFAR-100 的 PreActResNet-50 模型。"""
...
if __name__ == '__main__':
    ...
    print("正在运行 PreActResNet50.py 进行 CIFAR-100 训练...") # <-- 修改
    set_seed(42)

    # --- 配置参数 ---
    # *** 修改: 更新模型名称 ***
    MODEL_NAME = "PreActResNet50_CIFAR100" # <--- 修改
